...
<div class="cart-gifts" style="margin-top: 30px; border: 1px solid #eee; padding: 15px;">
    <h3>🎁 Your Free Gift!</h3>
    <p>Enjoy a free shaker bottle with your order.</p>
</div>

<div class="cart-recommended" style="margin-top: 30px; border: 1px solid #eee; padding: 15px;">
    <h3>Recommended for You</h3>
    <?php
    // Show 2 random products from the shop
    echo do_shortcode('[products limit="2" columns="2" orderby="rand"]');
    ?>
</div>
